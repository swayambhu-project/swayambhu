...
Examples:
    init_skill.py my-new-skill --path swayambhu/skills
    init_skill.py my-new-skill --path swayambhu/skills --resources scripts,references
    init_skill.py my-api-helper --path swayambhu/skills --resources scripts --examples
    init_skill.py custom-skill --path workspace/skills
"""
...
- Concrete examples with realistic inbound messages
